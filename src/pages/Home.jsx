...
/* ───── Hero pointer-tracking spotlight ───── */
    ...
    <div className="min-h-screen bg-mesh-light">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-15%] right-[-5%] w-[40rem] h-[40rem] bg-accent-500/25 rounded-full blur-3xl animate-blob" />
          <div className="absolute bottom-[-20%] left-[-15%] w-[40rem] h-[40rem] bg-primary-500/30 rounded-full blur-3xl animate-blob-slow" />
          <div className="absolute top-[35%] left-[42%] w-80 h-80 bg-fuchsia-500/15 rounded-full blur-3xl animate-drift" />
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="mt-10 flex items-center gap-4 animate-fade-up delay-500">
                <div className="flex -space-x-3">
                  {[
                    ...
                    <img key={i} src={src} alt="" className="w-9 h-9 rounded-full ring-2 ring-navy-900 object-cover" />
                  ))}
            ...
            <div className="hidden lg:block lg:col-span-5 relative h-[460px]">
              ...
              {heroPick && (
                ...
                >
                  <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-4 shadow-2xl ring-1 ring-white/40 hover:scale-105 transition-transform duration-500">
                    ...
                    <div className="aspect-square rounded-2xl overflow-hidden bg-gray-100">
                      <img src={heroPick.image} alt={heroPick.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                    </div>
              ...
              {products.slice(1, 3).map((p, i) => {
                ...
                return (
                  <Link
                    ...
                    to={`/products/${p.id}`}
                    style={pos}
                    className="absolute w-32 bg-white/90 backdrop-blur rounded-2xl p-2 shadow-xl hover:scale-110 transition-transform animate-float"
                  >
      ...
      {bentoPicks.length >= 6 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="grid grid-cols-12 gap-4 sm:gap-5 auto-rows-[140px] sm:auto-rows-[180px]">
            ...
            >
              <img src={bentoPicks[0].image} alt={bentoPicks[0].name}
            ...
            >
              <img src={bentoPicks[1].image} alt={bentoPicks[1].name}
            ...
            >
              <img src={bentoPicks[2].image} alt={bentoPicks[2].name}
