  ...
  return (
    ...
    >
      ...
      <rect x="14" y="24" width="28" height="18" rx="6" ry="6"
        fill="none" stroke="#b5673a" strokeWidth="2.5" />
      {/* Right lens frame */}
      <rect x="58" y="24" width="28" height="18" rx="6" ry="6"
        fill="none" stroke="#b5673a" strokeWidth="2.5" />
      {/* Bridge between lenses */}
      <line x1="42" y1="33" x2="58" y2="33" stroke="#b5673a" strokeWidth="2.5" />
      {/* Left arm */}
      <line x1="14" y1="33" x2="8" y2="30" stroke="#b5673a" strokeWidth="2" strokeLinecap="round" />
      {/* Right arm */}
      <line x1="86" y1="33" x2="92" y2="30" stroke="#b5673a" strokeWidth="2" strokeLinecap="round" />
      {/* Lens tint */}
      <rect x="15.5" y="25.5" width="25" height="15" rx="5" ry="5"
        fill="#2a221b" fillOpacity="0.6" />
      ...
      {/* Bezel inner ring */}
      <circle cx="50" cy="68" r="21" fill="#120e0a" />
      {/* Watch face */}
      ...
      <line x1="50" y1="68" x2="43" y2="60"
        stroke="#2a221b" strokeWidth="2.5" strokeLinecap="round" />
      {/* Minute hand — pointing to ~2 */}
      <line x1="50" y1="68" x2="56" y2="57"
        stroke="#2a221b" strokeWidth="2" strokeLinecap="round" />
      {/* Second hand — gold */}
      <line x1="50" y1="68" x2="54" y2="80"
        stroke="#b5673a" strokeWidth="1.2" strokeLinecap="round" />
      {/* Center dot */}
      <circle cx="50" cy="68" r="2" fill="#2a221b" />

      {/* Crown at 3 o'clock */}
      <rect x="72" y="66" width="5" height="4" rx="1" fill="#b5673a" />

      {/* Watch strap top */}
      <rect x="45" y="44" width="10" height="6" rx="2" fill="#b5673a" opacity="0.7" />
      {/* Watch strap bottom */}
      <rect x="45" y="90" width="10" height="6" rx="2" fill="#b5673a" opacity="0.7" />
    </svg>
  );
}
