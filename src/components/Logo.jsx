...
export function VexLogoMark({ size = 40 }) {
  ...
  return (
    ...
    >
      ...
      <line x1="42" y1="33" x2="58" y2="33" stroke="#7c3aed" strokeWidth="2.5" />
      {/* Left arm */}
      <line x1="14" y1="33" x2="8" y2="30" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" />
      {/* Right arm */}
      <line x1="86" y1="33" x2="92" y2="30" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" />
      {/* Lens tint */}
      <rect x="15.5" y="25.5" width="25" height="15" rx="5" ry="5"
        fill="#1e1b4b" fillOpacity="0.6" />
      ...
      {/* Bezel inner ring */}
      <circle cx="50" cy="68" r="21" fill="#0b0b14" />
      {/* Watch face */}
      ...
      {/* Center dot */}
      <circle cx="50" cy="68" r="2" fill="#1e1b4b" />

      {/* Crown at 3 o'clock */}
      <rect x="72" y="66" width="5" height="4" rx="1" fill="#7c3aed" />

      {/* Watch strap top */}
      <rect x="45" y="44" width="10" height="6" rx="2" fill="#7c3aed" opacity="0.7" />
      {/* Watch strap bottom */}
      <rect x="45" y="90" width="10" height="6" rx="2" fill="#7c3aed" opacity="0.7" />
    </svg>
  );
}
